...
- **Visualizations**: Using **[Tableau](https://public.tableau.com/views/TV-ShowAnalysis/TV-SHOWSOVERVIEW?:language=es-ES&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)
** to generate insightful and interactive graphs, including:
